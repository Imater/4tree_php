...
<ul>
    ...
    <li dont_close="true"><input type="checkbox" class="on_off" id="on_off_hide_did"></input>
    	<a class="show_hidden_do" style="margin-right:90px;">Показывать выполненные дела</a>
    </li>
	...
	<li class=""><a href="#"><i class='icon-plus'></i>Добавить</a>
		<ul>
    ...
    <li><a><i class="icon-cloud"></i>Синхронизация</a>
        ...
        <li class="blank"></li>
	<li id="exit_and_purge" title="Удаление ваших персональных данных в этом браузере (но не на сервере)">
		<a><i class="icon-cancel-1"></i>Выход</a>
	</li>
  </li>
	  ...
	  <div id="tree_editor" class="bottom_open_no">
			  ...
			  <div id="resize_me1"></div>
	  		  ...
	  		  <div id="myslidemenu" class="jqueryslidemenu noselectable" style="z-index:50">
		  		  <ul>
		  		  <li class="top_level">
		  		      <a class="redactor_menu"><i class="icon-th-list" style=""></i>&nbsp;</a>
		  			  	<ul>
	   ...
	   <div class="makedone_pages">
		   ...
		   <div class="makedone_page_1 page">
		    ...
		    <div class="makedone_page_4 page">
				...
				<div class="gradient_line" style="margin-top:15px;margin-bottom:15px;"></div>
		    	<div class="encrypt_note master_active" >
		    		Зашифровать заметку используя:<br>
		    		<div class="pass_block">
		    			<i id="password_lock_now_master" class="icon-lock-open pass_locker encrypted" title="Мастер-пароль общий для всех заметок дерева. Рекомендуется. Вводится при каждом запуске браузера, после этого все заметки доступны. Пароль восстановлению не подлежит. Обязательно записывайте в надёжное место."></i>
		    			<i id="password_lock_now_user" class="icon-lock-open pass_locker" title="Индивидуальный пароль для этой заметки. Рекомендуется только для самых важных заметок. Нужно будет вводить при каждом открытии заметки. Пароль восстановлению не подлежит. Обязательно записывайте в надёжное место."></i><br>
			    		<b class="label_master">Мастер-пароль:</b>
			    		<b class="label_user">Индивидуальный пароль:</b>
		    		</div>
