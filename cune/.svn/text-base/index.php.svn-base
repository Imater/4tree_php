...
<title>Cune Web Form - сервис по распознованию текста на сервере Нижегородского радиотехнического колледжа</title>
<FRAMESET COLS="180px,*">
	<FRAMESET rows="180px,*">
	...
	<frameset rows="80px,*">
		<frame src='links.php' name='frame3'>
		<frame src='main.php' name='frame4'>
	</FRAMESET>
</FRAMESET>
</head>
<body>
