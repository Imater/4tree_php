...
<table>
	<tr>
		<td><img src="tux.png" style="border: 0px solid ;" border="0" ></td>
		<td>
			<center>
				<H1>Добро пожаловать в систему распознования текста CuneWebForm.</H1><br>
				<H2>Для продолжения работы пройдите по ссылкам вверху.</H2>
			</center>
		</td>
	</tr>
</table>
