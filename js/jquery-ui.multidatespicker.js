...
/*						
						if (false && this.multiDatesPicker.mode == 'normal' && this.multiDatesPicker.dates.picked.length > 0 && this.multiDatesPicker.pickableRange) {
...
*/
					...
					beforeShowDay : function(date) {
						...
						return [selectable_date && custom[0], highlight_class, finddate[1]];
					},
