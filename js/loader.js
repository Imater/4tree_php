...
(function ($) {
  ...
  $.fn.krutilka = function (o) {
    var options = {
      size: 30, // Ширина и высота блока с крутилкой
      petals: 10, // Сколько лепестков у крутилки
      petalWidth: 3, // Толщина лепестка
      petalLength: 6, // Длина лепестка
      petalOffset: 0, // Внутреннее поле блока с крутилкой (расстояние до кончика лепестка)
      time: 1200, // Время прохода круга в миллисекундах
      color: '#333', // Цвет лепестков
