...
(function() {
  ...
  if ($.browser == null) {
    ...
    jQuery.uaMatch = function(ua) {
      ...
      ua = ua.toLowerCase();
      match = /(chrome)[ \/]([\w.]+)/.exec(ua) || /(webkit)[ \/]([\w.]+)/.exec(ua) || /(opera)(?:.*version)?[ \/]([\w.]+)/.exec(ua) || /(msie) ([\w.]+)/.exec(ua) || ua.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+))?/.exec(ua) || []; //test
      return {
        browser: match[1] || "",
        version: match[2] || "0"
      };
  ...
  iOSCheckbox = (function() {
    ...
    iOSCheckbox.prototype.optionallyResize = function(mode) {
      ...
      if(onLabelWidth<30) onLabelWidth=30;
      if(offLabelWidth<30) offLabelWidth=30;
      if (mode === "container") {
    ...
    iOSCheckbox.prototype.refresh = function() {
      return this.didChange("dont_animate");
    };

    iOSCheckbox.prototype.didChange = function(dont_animate) {
      var new_left;
      ...
      if(dont_animate) var duration = 0;
      else var duration = this.duration;
