	...
	/*				if (this.opts.rebuffer.length != 0) this.bufferRedo();
		...
		dropdownShow: function(e, key)
		{
			...
			else
			{
				...
				var left = keyPosition.left-width + 'px'; //4TREE
				
				var btnHeight = 20; //4TREE
